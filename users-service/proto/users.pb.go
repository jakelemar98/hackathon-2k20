...
type UserServiceClient interface {
	...
	GetRoutes(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userServiceClient) GetRoutes(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
	err := grpc.Invoke(ctx, "/UserService/GetRoutes", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	GetRoutes(context.Context, *UserRequest) (*UserResponse, error)
}
...
func _UserService_GetRoutes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetRoutes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/UserService/GetRoutes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetRoutes(ctx, req.(*UserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _UserService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_GetRoutes_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	0x60, 0x56, 0x60, 0xd4, 0x60, 0x0d, 0x82, 0xf2, 0x8c, 0x7a, 0x18, 0x21, 0xe6, 0x07, 0xa7, 0x16,
	0x95, 0x65, 0x26, 0xa7, 0x0a, 0x69, 0x71, 0x71, 0xbb, 0xa7, 0x96, 0x80, 0x44, 0x5c, 0x12, 0x4b,
	0x12, 0x85, 0x78, 0xf4, 0x90, 0x2c, 0x97, 0xe2, 0xd5, 0x43, 0xb1, 0x47, 0x9d, 0x8b, 0xc3, 0x3d,
	0xb5, 0x24, 0x28, 0xbf, 0xb4, 0x24, 0x15, 0xbf, 0x42, 0x0d, 0x2e, 0x4e, 0x98, 0xc2, 0x62, 0xbc,
	0x2a, 0x9d, 0xa4, 0xb9, 0xc4, 0x93, 0xf3, 0x73, 0xf5, 0xd2, 0x8b, 0x0a, 0x92, 0xf5, 0x8a, 0x21,
	0x4e, 0x2a, 0xd6, 0x03, 0x07, 0x47, 0x00, 0x63, 0x12, 0x1b, 0x38, 0x44, 0x8c, 0x01, 0x01, 0x00,
	0x00, 0xff, 0xff, 0x19, 0xb6, 0x2b, 0xbf, 0x20, 0x01, 0x00, 0x00,
}
